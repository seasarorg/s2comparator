...
public class ComparatorInterceptorTest extends S2FrameworkTestCase {
	...
	public void testIntercentor() throws Exception {

		EmpBeanComparator cmp = (EmpBeanComparator) this
				.getComponent(EmpBeanComparator.class);
	...
	public interface EmpBeanComparator {
		...
		Comparator<EmpBean> getEnameComparator();

		@OrderBy("hiredate desc nulls last")
		@RecordType(EmpBean.class)
		Comparator<EmpBean> getHiredateComparator();
